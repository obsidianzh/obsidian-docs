The File explorer lets you manage files and folders inside your vault. You can browse notes and other [[支持的文件格式]] in your vault and perform many common file operations:
